     ...
     Matrix m(this->row,this->col);
        if(this->row!=ref.row || this->col!= ref.col){
         ...
         for(int j=0; j<this->col; j++){
            m.data[i][j]=this->data[i][j] + ref.data[i][j];
        ...
        for(int i=0 ;i< this->row; i++){
         for(int j=0; j<ref.col; j++){
            ...
            for(int k=0; k<this->col; k++){
                m.data[i][j] += this->data[i][k] * ref.data[k][j];
            }
...
Matrix m3=m1+m2;
cout<<"using operator overloading sum of m1 and m2 is: "<<endl;
cout<<"matrix m3 is"<<endl;
m3.printMatrix();
Matrix m4=m1-m2;
cout<<"using operator overloading difference of m1 and m2 is: "<<endl;
cout<<"matrix m4 is"<<endl;
m4.printMatrix();
Matrix m5=m3*m4;
cout<<"using operator overloading product of m3 and m4 is: "<<endl;
cout<<"matrix m5 is"<<endl;
m5.printMatrix();
cout<<"using operator overloading assignment of m2 and m3 is: "<<endl;
m2=m3;
m2.printMatrix();
